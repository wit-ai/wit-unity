...
/// <summary>
/// NativeWebSocket is a wrapped of System.Net.WebSockets that is compatible with
/// WebGL and supports handling of upload and download bytes on a background thread.
/// </summary>
namespace Meta.Net.NativeWebSocket
{
    ...
    public class WebSocket : IWebSocket
    {
        ...
        public WebSocket(string url, Dictionary<string, string> headers = null)
        {
            ...
            var instanceId = WebSocketFactory.WebSocketAllocate(url);
        ...
        public WebSocket(string url, List<string> subprotocols, Dictionary<string, string> headers = null)
        {
            ...
            foreach (var subprotocol in subprotocols) WebSocketFactory.WebSocketAddSubProtocol(instanceId, subprotocol);
    ...
    public static class WebSocketFactory
    {
        ...
        public static void DelegateOnCloseEvent(int instanceId, int closeCode)
        {
            ...
            if (instances.TryGetValue(instanceId, out instanceRef)) instanceRef.DelegateOnCloseEvent(closeCode);
        }
#endif
    }
